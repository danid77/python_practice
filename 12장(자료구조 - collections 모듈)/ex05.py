...
print("----------------------------")
dic.clear()
dic = defaultdict(int)     # 키에 대한 값을 int형(0)으로 설정하였다.
dic["a"] += 100            # 해당 키에 대한 값에다가 연산을 할 수도 있다.
dic["b"] += 400            # 해당 키에 대한 값에다가 연산을 할 수도 있다.
print(dic["a"])
print(dic["b"])
print(dic[100])
print(dic)
...
print("----------------------------")
dic.clear()
dic = defaultdict(float)     # 키에 대한 값을 float형(0.0)으로 설정하였다.
print(dic["a"])
print(dic["b"])
print(dic[100])
print(dic)
...
print("----------------------------")
dic.clear()
dic = defaultdict(str)     # 키에 대한 값을 str형('')으로 설정하였다.
print(dic["a"])
print(dic["b"])
print(dic[100])
print(dic)