...
# 리스트에 대한 참조
li = ["사과", "바나나", "복숭아", "토마토"]
# 아래 출력코드는 없는 인덱스를 찹조하므로 애러가 발생함
...
li2 = [3,4,5]
print("li1의 주소값 : ", id(li2))
li3 = [6,7,8,8]
print("li1의 주소값 : ", id(li3))

li4 = li1 + li2 + li3
print("li4의 주소값 : ", id(li4))
print(li4)

# *연산자는 시퀀스 자료형에서 해당하는 값을 반복시켜서 요소의 수가 증가됨.
print(["안녕", "hi"]*3)
# in 연산자는 시퀀스 자료형에서 해당하는 값이 있다면 True를 반환
print(10 in [10,2,3])

# not in 연선자는 시퀀스 자료형에 해당하는 값이 있다면 False를 반환한다.
